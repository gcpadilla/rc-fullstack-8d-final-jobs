    ...
    <>
      <div className="card m-2 shadow border-0 cartelJobs container d-flex flex-column">
        <div className="card-body row align-items-center">
          ...
          <div className="col-4">
            <img
              className="imageLogoCard card-img rounded-circle btn-sm"
          ...
          <Link
            to="/"
            className="btn btn-primary btn-sm rounded-pill mr-1 mt-1"
          >
            {props.button} Testing
          </Link>
          <Link
            to="/"
            className="btn btn-primary btn-sm rounded-pill mr-1 mt-1"
