        ...
        <div className="searchBar d-flex flex-column">
            ...
            <div className="container d-flex flex-wrap align-items-top">
                <div className="col-sm-12 col-md-4 dataInstitucional text-white d-flex flex-column my-2 ">
                    ...
                    <Link className="tituloLinks text-decoration-none " to="/informacion">¿Quiénes Somos?</Link>
                    <Link className="tituloLinks text-decoration-none " to="/contacto">Contacto</Link>
                </div>
                <div className="col-sm-12 col-md-4 dataCandidatos text-white d-flex flex-column my-2">
                    ...
                    <Link className="tituloLinks text-decoration-none " to="/faqcandidates">Preguntas Frecuentes</Link>
                    <Link className="tituloLinks text-decoration-none " to="/offers" >Empleos por Categorías</Link>
                </div>
                <div className="col-sm-12 col-md-4 Empresa text-white d-flex flex-column my-2">
                    <h3 className="tituloFooter">Empresas</h3>
                    <Link className="tituloLinks text-decoration-none " to="/faqbusiness">Preguntas Frecuentes</Link>
                    <Link className="tituloLinks text-decoration-none " to="/prices">Precios</Link>
                </div>
            </div>
            </div>
