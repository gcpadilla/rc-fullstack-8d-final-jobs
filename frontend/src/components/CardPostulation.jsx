    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title className="tituloCartel">
            {" "}
            oferta de {props.titulo}
          </Modal.Title>
        </Modal.Header>
        <div className="card">
          <ul className="list-group list-group-flush">
            <li className="list-group-item">
              <MdDescription /> {props.all.description}
            </li>
            <li className="list-group-item">
              <MdEventAvailable /> {props.all.availability}
            </li>
            <li className="list-group-item">
              <MdPlace /> {props.all.workplace}
            </li>
          </ul>
        </div>
        <Modal.Body>
