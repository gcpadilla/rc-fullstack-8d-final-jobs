      ...
      <h3 className="text-center my-5">Un Producto para cada Necesidad</h3>
        ...
        <CardDeck className="d-flex justify-content-center flex-wrap">
          <Card>
            ...
            <Card.Body>
              <Card.Title className="tituloCardSale text-center ">
                Aviso Clásico
              </Card.Title>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title className="text-center tituloCardSale">
                Aviso Gold
              </Card.Title>
              <Card.Text className="text-center">
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 col-sm-12 row d-flex align-items-center">
              ...
              <p className="col-10">
                Ofrecemos una solución simple e integral de reclutamiento
              </p>
            </div>
            <div className="col-md-6 col-sm-12 row d-flex align-items-center">
              <img className="col-2" src={flag} alt="flag" />
              <p className="col-10">
                Disponemos de herramientas personalizadas para la necesidad de
                cada cliente.{" "}
              </p>
            </div>
            <div className="col-md-6 col-sm-12 row d-flex align-items-center">
              ...
              <p className="col-10">
                Contribuimos a la imagen de tu empresa como marca empleadora.{" "}
              </p>
            </div>
            <div className="col-md-6 col-sm-12 row d-flex align-items-center">
